...
//   return (
//     <div className="relative min-h-screen bg-[#f0f4f9] text-[#1f1f1f] font-sans pb-16 overflow-hidden">
//       {/* Decorative Angled Color Stripes (Fateh Theme) */}
//       <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
//         <div className="absolute -top-20 -right-20 w-[600px] h-[150vh] flex -skew-x-12 opacity-90 origin-top-right">
//           <div className="h-full w-1/3 bg-[#0072ce]" />
//           <div className="h-full w-1/3 bg-[#ffc72c]" />
//           <div className="h-full w-1/3 bg-[#e40046]" />
//         </div>
//       </div>

//       {/* Top Navigation Header */}
//       <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-[#dadce0] px-6 py-3 shadow-xs">
//         <div className="max-w-7xl mx-auto flex items-center justify-center">
//           <h2 className="text-base sm:text-lg font-bold text-[#3c4043]">
//             Fateh Campus Ambassador <span className="text-[#1a73e8] font-bold">2026</span>
//           </h2>
...
//       <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 mt-8 space-y-8">
//         <div className="flex flex-col items-center justify-center my-6">
//           <div className="relative flex items-center justify-center w-36 h-36 rounded-full bg-white border-4 border-[#1a73e8] shadow-md transition-transform hover:scale-105">
//             <div className="flex flex-col items-center justify-center text-center p-2">
//               <Percent className="w-6 h-6 text-[#1a73e8] mb-0.5" />
...
//                   ? Math.round(((ambassador?.taskCompleted || 0) / filteredTasks.length) * 100)
//                   : 0}
//               </span>
//               <span className="text-[10px] font-bold uppercase tracking-wider text-[#5f6368] mt-0.5">
//                 Task Submission Percentage
...
//         {/* Banner Section */}
//         <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/90 backdrop-blur-xs rounded-2xl border border-[#dadce0] p-6 shadow-xs">
//           <div>
//             <h1 className="text-2xl font-bold text-[#202124]">Ambassador Task Dashboard</h1>
//             <p className="text-xs text-[#5f6368] mt-1">
//               Track your assigned deliverables, targets.
