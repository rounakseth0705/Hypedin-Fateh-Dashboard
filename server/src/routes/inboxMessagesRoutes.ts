...
import { deleteMessageFromInbox, getMessages, sendMessageToInbox } from "../controllers/inboxMessageControllers.js";
...
inboxMessagesRouter.delete("/deleteMessage/:messageId", authMiddleware, verifyAccess("Admin"), deleteMessageFromInbox);
